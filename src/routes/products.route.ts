...
import { productSchema, searchQuerySchema, updateProductSchema } from "../models/product.model.js";
...
productsRoutes.post("/products", celebrate({ [Segments.BODY]: productSchema}), asyncHandler(ProductsController.save));
